...
- clone this repo
- set up a virtual environment wherever you want to run your tests (bq-prosperity repo in this case)
- cd into this repo/directory
- run ```pip install -e .``` while in your virtual environment
- you're set. should be able to verify if you run ```which prosperity4bt```
- all below instructions can be ran by replacing "prosperity3bt" with "prosperity4bt"
